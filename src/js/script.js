...
const showImg = e => {
	...
	switch (imgClassName) {
		case 'img one':
			...
			imgBig.setAttribute('src', './dist/img/big/1.jpg')
			break
		case 'img two':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/2.jpg')
			break
		case 'img three':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/3.jpg')
			break
		case 'img four':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/4.jpg')
			break
		case 'img five':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/5.jpg')
			break
		case 'img six':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/6.jpg')
			break
		case 'img seven':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/7.jpg')
			break
		case 'img eight':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/8.jpg')
			break
		case 'img nine':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/9.jpg')
			break
		case 'img ten':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/10.jpg')
			break
		case 'img eleven':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/11.jpg')
			break
		case 'img twelve':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/12.jpg')
			break
		case 'img thirteen':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/13.jpg')
			break
		case 'img fourteen':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/14.jpg')
			break
		case 'img fifteen':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/15.jpg')
			break
		case 'img sixteen':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/16.jpg')
			break
		case 'img seventeen':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/17.jpg')
			break
		case 'img eighteen':
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/18.jpg')
			break
		default:
			imgBig.removeAttribute('src')
			imgBig.setAttribute('src', './dist/img/big/1.jpg')
...
const previousImg = () => {
	...
	imgBig.setAttribute('src', `./dist/img/big/${numberPhoto - 1}.jpg`)

	if (numberPhoto === 1) {
		imgBig.setAttribute('src', `./dist/img/big/${imgSmall.length}.jpg`)
	}
...
const showPosition = () => {
	...
	if (imgBig.getAttribute('src') === `./dist/img/big/${numberPhoto}.jpg`) {
